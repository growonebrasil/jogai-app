...
import { useFeedPosts, useToggleLike, usePostComments, useAddComment, type FeedPost } from "@/hooks/useFeed";
      ...
      <div className="min-h-full" style={{ background: "linear-gradient(180deg, hsl(214 25% 10%) 0%, hsl(214 28% 8%) 100%)" }}>
        <div className="max-w-xl mx-auto p-4 md:p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h1 className="font-display text-2xl md:text-3xl font-bold text-foreground">Feed</h1>
